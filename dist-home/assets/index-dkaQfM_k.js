import{F as H,a as $,l as B}from"./auth-DorHJIda.js";const G=[{slug:"the-resonance-update",title:"The Resonance Update — Nine New Towns and a World of Skills",category:"Game Updates",date:"2026-06-13",excerpt:"The biggest content drop in Larpscape history: nine new towns, a mining overhaul, and a real destination for nearly every skill. The whole valley is ringing.",accent:"#2bb0a3",body:`Cantorne was sung into being, and this week the whole valley found its voice. The **Resonance Update** is the largest content drop we have ever shipped — a dedicated home and a real progression for nearly every skill, all at once.
...
The cube era is survived by one screenshot on the office wall, labeled *the Unstruck Age*. Onward.`}],n=(e,t="0 0 24 24")=>`<svg viewBox="${t}" aria-hidden="true" focusable="false">${e}</svg>`,h={sword:n(`<path d="M4 20 L15 9 M13 7 l4 -4 l4 1 l1 4 l-4 4 Z M3 17 l4 4 M2.5 21.5 l2 -2"
     ...
     <path d="M9 9 h6 M9 12.5 h6 M9 16 h4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>`),trophy:n(`<path d="M7 4 h10 v5 a5 5 0 0 1 -10 0 Z M7 5.5 H4.5 a3 3 0 0 0 3 4 M17 5.5 h2.5 a3 3 0 0 1 -3 4 M12 14 v3 M8.5 20.5 h7 M10 17 h4 l1 3.5 h-6 Z"
      stroke="currentColor" stroke-width="1.7" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`),discord:n(`<path d="M5 4 h14 a2 2 0 0 1 2 2 v8 a2 2 0 0 1 -2 2 H10 l-4 4 v-4 H5 a2 2 0 0 1 -2 -2 V6 a2 2 0 0 1 2 -2 Z"
      stroke="currentColor" stroke-width="1.7" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
     <circle cx="9" cy="10" r="1.15" fill="currentColor"/><circle cx="12.5" cy="10" r="1.15" fill="currentColor"/><circle cx="16" cy="10" r="1.15" fill="currentColor"/>`),book:n(`<path d="M12 6 c-2 -1.6 -5 -2 -8 -1.6 V 19 c3 -.4 6 0 8 1.6 c2 -1.6 5 -2 8 -1.6 V 4.4 C17 4 14 4.4 12 6 Z M12 6 v14.6"
     ...
     <path d="M11 11 L20 20 M17 17 l2.5 -2.5 M14.5 14.5 l2 -2" stroke="currentColor" stroke-width="1.8" fill="none" stroke-linecap="round"/>`),quill:n(`<path d="M20 4 C13 5 8 9 6.5 15.5 L5 20 l4.5 -1.5 C16 17 19 11 20 4 Z M5.5 18.5 C9 12 13 8.5 17 6.5"
      ...
      stroke="currentColor" stroke-width="1.7" fill="none" stroke-linecap="round" stroke-linejoin="round"/>`),economy:n(`<circle cx="12" cy="12" r="8.5" stroke="currentColor" stroke-width="1.7" fill="none"/>
     ...
     <path d="M12 8.8 v6.4 M9.8 10.4 c0 -1 1 -1.6 2.2 -1.6 s2.2 .6 2.2 1.5 c0 2.2 -4.4 1 -4.4 3.2 c0 1 1 1.6 2.2 1.6 s2.2 -.6 2.2 -1.6"
      stroke="currentColor" stroke-width="1.4" fill="none" stroke-linecap="round"/>`)},R={skills:n(`<path d="M4 8 h13 c-.5 2.5 -2.5 4 -5 4.5 V 15 c2 .6 3 1.8 3.5 3.5 h-9 C7 16.8 8 15.6 10 15 v-2.5 C6.5 12 4.5 10.5 4 8 Z"
     ...
     <path d="M4.5 19.5 L19.5 6.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" opacity=".85"/>`)},U={"Game Updates":h.sword,"Dev Blog":h.quill,Community:h.banner,Events:h.bell};function P(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function k(e){return P(e).replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>").replace(/\*([^*]+)\*/g,"<em>$1</em>").replace(/`([^`]+)`/g,"<code>$1</code>")}function W(e){const t=e.trim().split(/\n\s*\n/),a=[];for(const l of t){const i=l.split(`
`).map(r=>r.trim()).filter(Boolean);i.length>0&&i.every(r=>r.startsWith("- "))?a.push(`<ul>${i.map(r=>`<li>${k(r.slice(2))}</li>`).join("")}</ul>`):a.push(`<p>${k(i.join(" "))}</p>`)}return a.join("")}const x="https://play.larpscape.net",v="https://wiki.larpscape.net",j="https://trade.larpscape.net",T="https://github.com/MroppyDev/larpscape";function o(e){const t=document.getElementById(e);if(!t)throw new Error(`missing #${e}`);return t}function s(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const D={"rail-game-list":[{label:"Play Larpscape",href:x,icon:"sword"},{label:"News & updates",href:"#news",icon:"scroll"},{label:"Hiscores",href:"#hiscores",icon:"trophy"},{label:"New player guide",href:`${v}/guide/getting-started`,icon:"book",ext:!0}],"rail-community-list":[{label:"Forum",href:H,icon:"quill",ext:!0},{label:"The Larpscape Wiki",href:v,icon:"book",ext:!0},{label:"The Aldgate Exchange",href:j,icon:"economy",ext:!0},{label:"Join our Discord",href:"https://discord.gg/jmqTS23Ttb",icon:"discord",ext:!0},{label:"Guilds & trading",href:"#about",icon:"banner"},{label:"GitHub",href:T,icon:"code",ext:!0}],"rail-account-list":[{label:"Create account",href:"/register",icon:"quill"},{label:"Log in",href:"/login",icon:"key"},{label:"Support",href:`${T}/issues`,icon:"bell",ext:!0}]};for(const[e,t]of Object.entries(D))o(e).innerHTML=t.map(a=>`<li><a href="${a.href}"${a.ext?' class="ext"':""}>${h[a.icon]??""}<span>${s(a.label)}</span></a></li>`).join("");(async()=>{const e=await $();if(!e)return;const t=o("auth-strip");t.innerHTML=`
    ...
    <button class="login-plaque" id="strip-logout" type="button">Log out</button>`,o("strip-logout").addEventListener("click",()=>{(async()=>{const a=o("strip-logout");a.disabled=!0,a.textContent="Logging out…",await B(),location.reload()})()})})();const c={href:x,title:"The Untuned Mine is open",sub:"Solo dungeon · two bosses · the plaque remembers"};c&&(o("promo-slot").innerHTML=`
  ...
  <article class="feature">
    ...
    <div class="hiscores-table-wrap">
    ...
    </div>`}function _(e,t){return t.map(a=>{const l="totalLevel"in a?a.totalLevel:a.level,i="totalXp"in a?a.totalXp:a.xp;return`<tr${a.rank<=3?` class="podium-${a.rank}"`:""}>
      ...
      </tr>`}).join("")}async function A(e){const t=++m,a=M.get(e);if(a){u.innerHTML=a;return}u.innerHTML=Q();try{const l=await fetch(`/api/hiscores?skill=${encodeURIComponent(e)}&limit=10`);if(!l.ok)throw new Error(String(l.status));const i=await l.json();if(t!==m)return;let r;!i.ranking||i.ranking.length===0?r='<p class="hiscores-note">No names on the plaque yet — be the first on the board.</p>':r=E(e==="overall"?"Total":"Level",_(e,i.ranking)),M.set(e,r),u.innerHTML=r}catch{if(t!==m)return;u.innerHTML='<p class="hiscores-note error">The surveyor’s plaque is unreadable right now — try again shortly.</p>'}}y.addEventListener("change",()=>void A(y.value));A("overall");const q=new IntersectionObserver(e=>{for(const t of e)t.isIntersecting&&(t.target.classList.add("in"),q.unobserve(t.target))},{threshold:.08});document.querySelectorAll(".reveal").forEach(e=>q.observe(e));
