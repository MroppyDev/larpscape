...
// gaps (call-and-response), and mallet "drips" (celesta) fall on off-grid
// spots with odd chromatic neighbors (Eb6, C#6) for damp unease.
...
export const track: Track = {
  ...
  channels: [
    // LEAD — low clarinet, the "sink and slip" motif. Full 32-bar form.
    { program: P.CLARINET, gain: 0.20, octave: 4, wave: 'triangle', pan: 0, notes: seq(`
      D:6 -   F:6 -   E:5 -   D#:4 -
      D:5 -   -   -   -   -   .    .
      G:6 -   A#:6 -  A:5 -   G#:4 -
      G:5 -   -   -   -   -   F:3  E:3
    ...
    // COUNTER — bassoon, answers the clarinet in its rests. Carries the
    // world leitmotif (minor, on G) at bars 17-18: G A# D4 | D#4 D4 A#.
    { program: P.BASSOON, gain: 0.13, octave: 3, wave: 'sawtooth', pan: -0.3, notes: seq(`
      .    .   .    .   .    .   .    .
      .    .   F:4  -   E:4  -   D#:3 D:3
      .    .   .    .   .    .   .    .
      .    .   A#:4 -   A:4  -   G#:3 G:3
    ...
    { program: P.CONTRABASS, gain: 0.14, octave: 2, wave: 'sine', pan: 0, notes: seq(`
      D:5  -   -    -   .    .   D:3   .
      D:4  -   -    -   A:4  -   -     -
      G:5  -   -    -   .    .   G:3   .
      G:4  -   -    -   A:3  -   C3:3  -
    ...
    // PAD — bowed-glass murk, one slow tone per harmony. Db3 sting at b29.
    { program: P.BOWED_PAD, gain: 0.07, octave: 3, wave: 'sine', pan: 0.2, notes: seq(`
      D:3  - - - - - - -   - - - - - - - -
      G:3  - - - - - - -   - - - - - - - -
      F:3  - - - - - - -   - - - - - - - -
      E:3  - - - - - - -   F:3 - - - - - - -
    ...
    // DRIPS — celesta droplets, irregular placement, chromatic neighbors
    // (Eb6, C#6) for the damp unease. 8-bar ostinato, loops 4x.
    { program: P.CELESTA, gain: 0.09, octave: 5, wave: 'sine', pan: 0.5, notes: seq(`
      .   .    .    D6:3 .    .   .     .
      .   A:2  .    .    .    .   D#6:3 .
      .   .    .    .    .    G:2 .     .
      .   .    D6:2 .    .    .   .     .
    ...
    { program: 0, drums: true, gain: 0.05, octave: 3, wave: 'square', pan: -0.2, notes: seq(`
      .  .   .   .   R:2 .   .   .
      .  .   T:2 .   .   .   .   X:1
      .  .   .   .   .   R:2 .   .
      .  .   .   .   .   .   .   .
