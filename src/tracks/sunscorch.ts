...
// heat-shimmer mode, double-reed lead, hand drums low in the dust.
//
...
export const track: Track = {
  ...
  channels: [
    // ---- LEAD: shanai, the snake-charmer line (defines the 32-bar loop) ----
    { program: P.SHANAI, gain: 0.2, octave: 5, wave: 'sawtooth', pan: 0.15,
      notes: seq(`
        D:8  -    -    D#   F#:7 -    D#   D:5
        C:6  -    D    -    A4:5 -    -    .
        D:7  -    -    D#   F#:7 -    G    A:8
    ...
    { program: P.OBOE, gain: 0.12, octave: 4, wave: 'triangle', pan: -0.35,
      notes: seq(`
        .    .    .    .    .    .    .    .
        .    .    .    .    D:5  D#   F#:6 D
        .    .    .    .    .    .    .    .
    ...
    // ---- PAD: bowed-glass heat shimmer, slow chord thirds (gain stays low) ----
    { program: P.BOWED_PAD, gain: 0.07, octave: 4, wave: 'sine', pan: 0.35,
      notes: seq(`
        F#:3 -    -    -    -    -    -    -
        -    -    -    -    -    -    -    -
        G:4  -    -    -    -    -    -    -
    ...
    // ---- BASS: contrabass drone on D with sudden scale runs at the turns ----
    { program: P.CONTRABASS, gain: 0.16, octave: 2, wave: 'sine', pan: 0,
      notes: seq(`
        D:7  -    -    -    D:4  -    -    -
        D:6  -    -    -    D:4  -    D:3  D:4
        D:6  -    -    -    D:4  -    -    -
    ...
    // ---- DRUMS: hand-drum groove (low toms + shaker), 8-bar loop, fill at the turn ----
    { program: 0, gain: 0.09, octave: 3, wave: 'sine', pan: -0.1, drums: true,
      notes: seq(`
        T:7  X:3  X:4  T:4  U:5  X:3  T:6  X:4
        T:7  X:3  U:4  X:3  T:5  X:3  U:5  X:4
        T:7  X:3  X:4  T:4  U:5  X:3  T:6  X:4
        T:7  X:3  U:4  T:5  U:6  X:3  T:5  X:4
        T:7  X:3  X:4  T:4  U:5  X:3  T:6  X:4
        T:7  X:3  U:4  X:3  T:5  X:3  U:5  X:4
        T:7  X:3  X:4  T:4  U:5  X:3  T:6  X:4
        T:6  T:4  U:5  T:6  U:6  T:7  T:8  U:6`) },
  ],
};
